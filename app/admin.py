...
class ResultadoAdmin(admin.ModelAdmin):
	...
	exportable_fields = ('usuario','fecha', 'local', 'marcadorLocal', 'visitante', 'marcadorVisitante', 'puntos')

class PartidoInline(admin.StackedInline):
	model = Partido
	extra = 10
...
admin.site.register(PartidoFinal)
admin.site.register(Usuario)
admin.site.register(FechaAJugar)
admin.site.register(TablaFecha)